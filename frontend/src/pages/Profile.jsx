  ...
  return (
    <>    
      ...
      <Main>
        <SideBar>
          <ul>
            <li><a href="/profile"><i class="bi bi-person-fill"></i>Perfil</a></li>
            <li><a href="/account"><i class="bi bi-gear"></i>Cuenta</a></li>
            <li><a href="/privacy"><i class="bi bi-lock-fill"></i>Privacidad</a></li>
            <li><a href="/notifications"><i class="bi bi-bell-fill"></i>Notificaciones</a></li>
            <li><a href="/appareance"><i class="bi bi-eye"></i>Apariencia</a></li>
          </ul>
        </SideBar>
